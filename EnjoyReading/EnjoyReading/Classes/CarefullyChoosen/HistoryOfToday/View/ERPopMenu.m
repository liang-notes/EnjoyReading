...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        container.image = [UIImage imageWithStretchableName:@"popover_background"];
...
- (void)setArrowPosition:(ERPopMenuArrowPosition)arrowPosition
{
    _arrowPosition = arrowPosition;
    
    switch (arrowPosition) {
        case ERPopMenuArrowPositionCenter:
            self.container.image = [UIImage imageWithStretchableName:@"popover_background"];
            break;
            
        case ERPopMenuArrowPositionLeft:
            self.container.image = [UIImage imageWithStretchableName:@"popover_background_left"];
            break;
            
        case ERPopMenuArrowPositionRight:
            self.container.image = [UIImage imageWithStretchableName:@"popover_background_right"];
            break;
    }
}
